...
//************************SQL registro***************************//
	...
	{
		$sql="INSERT INTO usuarios (codigo_tipo_doc,numero_doc,nombre,apellido,correo,contraseña) VALUES ('$this->tdocumento','$this->ndocumento','$this->nombre','$this->apellido','$this->correo','$this->codigo')";
