          ...
          <div  class="titulo">
            ...
            <div class="col-md-12" style="padding-top: 20px; padding-bottom: 80px;">
                <div class="col-md-6 col-sm-6 col-xs-6">  
                  <div class="form-group">
                    <label  for="NumJor" class="sr-only" >Número Jornada</label> 
                      <div class="">
                      <input type="text" id="NumJor" name="NumJor" autocomplete="OFF" required="" placeholder="Código Jornada"  class="form-control">
                      </div>
                  </div>
                </div> 
                <div class="col-md-6 col-sm-6 col-xs-6">  
