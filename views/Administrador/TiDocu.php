          ...
          <div  class="titulo">
              ...
              <div class="col-md-12" style="padding-top: 20px; padding-bottom: 80px;">
                <div class="col-md-6 col-sm-6 col-xs-6">  
                  <div class="form-group">
                    <label  for="cdoc" class="sr-only" >Código Documento</label> 
                      <div class="">
                      <input type="text" id="cdoc" name="cdoc" autocomplete="OFF" required="" placeholder="Código Documento"  class="form-control">
                      </div>
                  </div>
                </div> 
                <div class="col-md-6 col-sm-6 col-xs-6">  
