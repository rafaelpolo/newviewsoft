...
<html lang="es">
  ...
  <header>
    ...
    <nav class="navbar navbar-inverse">
          <div>
           <a href="menuAdministrador.html" ><img src="/Newviesoft/Diseños/img/logo.png" alt="NewViewSoft" title="NewViewSoft" style="width: 40%;"></a>
          </div>

          <div>
           <a href="http://oferta.senasofiaplus.edu.co/sofia-oferta/"><img src="/Newviesoft/Diseños/img/intro.png" alt="NewViewSoft" title="NewViewSoft" style="position:absolute; width:12%; left:1110px; top:0px;"></a>
          </div>
    </nav>
      ...
      <div class="col-md-3 nov">
            <div class="col-md-12" >
              <div class="col-md-12 col-sm-12 col-xs-12">  
                  <div class="form-group">
                    <label  for="CodApla" class="sr-only" >Código Aplazamiento</label> 
                      <div class="">
                      <input type="text" id="CodApla" name="CodApla" autocomplete="OFF" required="" placeholder="Código Aplazamiento"  class="form-control">
                      </div>
                  </div>
              </div>
              <div class="col-md-12 col-sm-12 col-xs-12">  
      ...
      <div class="col-md-6 clase">                             
          <div  class="titulo">
            ...
            <div class="col-md-12">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">  
                  <div class="form-group">
                    <label  for="respuestapla" class="sr-only" >Respuesta</label> 
                      <div class="">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">  
                  <div class="form-group">
                    <label  for="msoloapla" class="sr-only" >Motivo Solicitud</label> 
                      <div class="">
