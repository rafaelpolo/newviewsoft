      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        ...
        <ul class="nav navbar-nav navbar-right">
           <li class="dropdown">
                  ...
                  <ul class="dropdown-menu" >
                    <li><a href="../ARol/ARol.html"><span class="glyphicon glyphicon-book"></span> Asignar Rol</a></li>
                    <li><a href="../Perfil/perfil.html"><span class="glyphicon glyphicon-user"></span> Perfil</a></li>
          ...
          <div  class="titulo">
              ...
              <div class="col-md-12" style="padding-top: 20px; padding-bottom: 80px;">
                <div class="col-md-6 col-sm-6 col-xs-6">  
                  <div class="form-group">
                    <label  for="codCar" class="sr-only" >Código Cargo</label> 
                      <div class="">
                      <input type="text" id="codCar" name="codCar" autocomplete="OFF" required="" placeholder="Código Cargo"  class="form-control">
                      </div>
                  </div>
                </div> 
                <div class="col-md-6 col-sm-6 col-xs-6">  
                  <div class="form-group">
                    <label  for="cargo" class="sr-only" >Cargo</label> 
                      <div class="">
                      <input type="text" id="cargo" name="cargo" autocomplete="OFF" required="" placeholder="Cargo"  class="form-control">
                      </div>
                  </div>
                </div> 
              </div>
...
<!--TÉRMINO DE PÁGINA-->
 ...
 <!--BOOTSTRAP JQUERY-->
     <script type="text/javascript" src="/Newviesoft/Diseños/bootstrap/js/jquery.js"></script>
      <script type="text/javascript" src="/Newviesoft/Diseños/bootstrap/js/bootstrap.min.js"></script>    </div>
</body>
</html>