      ...
      <div class="col-md-3 nov">
            <div class="col-md-12" >
              <div class="col-md-12 col-sm-12 col-xs-12">  
                  <div class="form-group">
                    <label  for="CodDeser" class="sr-only" >Código Deserción</label> 
                      <div class="">
                      <input type="text" id="CodDeser" name="CodDeser" autocomplete="OFF" required="" placeholder="Código Deserción"  class="form-control">
                      </div>
                  </div>
              </div>
              <div class="col-md-12 col-sm-12 col-xs-12">  
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">  
                  <div class="form-group">
                    <label  for="docuUsu" class="sr-only" >Documento Instructor</label> 
                      <div class="">
                      <input type="text" id="docuUsu" name="docuUsu" autocomplete="OFF" required="" placeholder="Documento Intructor"  class="form-control">
                      </div>
                  </div>
              </div>    
