      ...
      <div class="col-md-3 nov">
            <div class="col-md-12" >
              <div class="col-md-12 col-sm-12 col-xs-12">  
                    <div class="form-group">
                      <label  for="CodJor" class="sr-only" >Código Cambio Jornada</label> 
                        <div class="">
                        <input type="text" id="CodJor" name="CodJor" autocomplete="OFF" required="" placeholder="Código Jornada"  class="form-control">
                        </div>
                    </div>
                </div>
                <div class="col-md-12 col-sm-12 col-xs-12">  
