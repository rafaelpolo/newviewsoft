      ...
      <div class="col-md-3 nov">
            <div class="col-md-12" >
              <div class="col-md-12 col-sm-12 col-xs-12">  
                  <div class="form-group">
                    <label  for="CodRein" class="sr-only" >Código Reintegro</label> 
                      <div class="">
                      <input type="text" id="CodRein" name="CodRein" autocomplete="OFF" required="" placeholder="Código Reintegro"  class="form-control">
                      </div>
                  </div>
              </div>
              <div class="col-md-12 col-sm-12 col-xs-12">  
                  <div class="form-group">
                    <label  for="CodTras" class="sr-only" >Código Traslado</label> 
                      <div class="">
                      <input type="date" id="CodTras" name="CodTras" autocomplete="OFF" required="" placeholder="Código Traslado"  class="form-control">
                      </div>
                  </div>
              </div>
              <div class="col-md-12 col-sm-12 col-xs-12">  
                  <div class="form-group">
                    <label  for="FechaRein" class="sr-only" >Fecha Reintegro</label> 
                      <div class="">
                      <input type="date" id="FechaRein" name="FechaRein" autocomplete="OFF" required="" placeholder="Fecha Reintegro"  class="form-control">
                      </div>
                  </div>
              </div>
              <div class="col-md-12 col-sm-12 col-xs-12">  
                  <div class="form-group">
                    <label  for="FechaRein" class="sr-only" >Tiempo Reintegro</label> 
                      <div class="">
                      <input type="time" id="FechaRein" name="FechaRein" autocomplete="OFF" required="" placeholder="Tiempo Reintegro"  class="form-control">
                      </div>
                  </div>
              </div>
            </div>
      ...
      <div class="col-md-6 clase">                             
          <div  class="titulo">
            ...
            <div class="col-md-12">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">  
                  <div class="form-group">
                    <label  for="DesRvolun" class="sr-only" >Descripción</label> 
                      <div class="">
                      <textarea type="text" id="DesRvolun" name="DesRvolun" autocomplete="OFF" required="" placeholder="Descripción"  class="form-control" cols="10" rows="5"></textarea>
                      </div>
                  </div>
              </div>  
