          ...
          <div  class="titulo">
            ...
            <div class="col-md-12" style="padding-top: 20px; padding-bottom: 80px;">
                <div class="col-md-6 col-sm-6 col-xs-6">  
                  <div class="form-group">
                    <label  for="NumFor" class="sr-only" >Número Formación</label> 
                      <div class="">
                      <input type="text" id="NumFor" name="NumFor" autocomplete="OFF" required="" placeholder="Código Formación"  class="form-control">
                      </div>
                  </div>
                </div> 
                <div class="col-md-6 col-sm-6 col-xs-6">  
