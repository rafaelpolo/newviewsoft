          ...
          <div  class="titulo">
              ...
              <div class="col-md-12" style="padding-top: 20px; padding-bottom: 80px;">
                <div class="col-md-6 col-sm-6 col-xs-6">  
                  <div class="form-group">
                    <label  for="NumTri" class="sr-only" >Número Trimestre</label> 
                      <div class="">
                      <input type="text" id="NumTri" name="NumTri" autocomplete="OFF" required="" placeholder="Código Trimestre"  class="form-control">
                      </div>
                  </div>
                </div> 
                <div class="col-md-6 col-sm-6 col-xs-6">  
                  <div class="form-group">
                    <label  for="trimestre" class="sr-only" >Trimestre</label> 
                      <div class="">
                      <input type="text" id="trimestre" name="trimestre" autocomplete="OFF" required="" placeholder="Trimestre"  class="form-control">
                      </div>
                  </div>
                </div> 
              </div>
