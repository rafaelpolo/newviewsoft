  ...
  <!--MENU PRINCIPAL--> 
    ...
    <nav class="navbar navbar-fixed-top navbar-inverse"  >
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
          ...
          <li><a href="controller/olvido_codigo"><span class="glyphicon glyphicon glyphicon-lock"></span> ¿Olvido Su código?</a></li>
            <li><a href="controller/registro"><span class="glyphicon glyphicon-user"></span> Registrarse</a></li>
    ...
    <div class="col-md-12">
        ...
        <div class="carousel-inner">
             <div class="item active">
                <img src="/Newviesoft/Diseños/img/img1.png" alt="TÉCNOLOGIA" title="TÉCNOLOGIA" style="height: 500px;">
             </div>

             <div class="item">
                <img src="/Newviesoft/Diseños/img/img4.jpg" alt="TÉCNOLOGIA" title="TÉCNOLOGIA" style="height: 500px;" >
             </div>

            <div class="item">
                <img  src="/Newviesoft/Diseños/img/img3.jpg" alt="BIENVENIDOS" title="BIENVENIDOS" style="height: 500px;" >
            </div>
        </div>
